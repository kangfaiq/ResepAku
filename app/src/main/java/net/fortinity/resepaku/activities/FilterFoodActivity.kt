package net.fortinity.resepaku.activities
...
import net.fortinity.resepaku.R
import net.fortinity.resepaku.adapter.FilterFoodAdapter
import net.fortinity.resepaku.model.ModelFilter
import net.fortinity.resepaku.model.ModelMain
import net.fortinity.resepaku.networking.Api
...
class FilterFoodActivity : AppCompatActivity(), FilterFoodAdapter.onSelectData {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rvFilter.layoutManager = StaggeredGridLayoutManager(
            2,
        ...
        if (modelMain != null) {
            ...
            //Set text
            tvTitle.text = "Food List $strCategory"
